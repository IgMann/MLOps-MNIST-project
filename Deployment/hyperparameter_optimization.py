...
def hyperparameter_optimization(x_train, y_train, x_test, y_test, num_epochs, batch_size, validation_split):
    ...
    def objective(parameters):
        ...
        history = model.fit(x_train, y_train, epochs=num_epochs, batch_size=batch_size, validation_split=validation_split, verbose=0)
    ...
    print(100 * '=')
    print("HYPERPARAMETR OPTIMIZATION")
    print(100 * '=')

    start_time = time.time()

    print(100 * '-')
    print("Hyperparamter optimization started")
    print(100 * '-')

    best_parameters = fmin(fn=objective, space=space, algo=tpe.suggest, max_evals=10)

    print(100 * '-')
    print("Hyperparamter optimization ended")
    print(100 * '-')
